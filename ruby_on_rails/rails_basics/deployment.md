...
To find new a new domain, try using [Domainr](https://domainr.com/).
...
- Homepage link: [http://Fly.io](http://Fly.io)
...
- [Official getting started with Rails on Fly.io guide](https://fly.io/docs/rails/getting-started/)
...
- Homepage link: [https://railway.app/](https://railway.app/)
...
- [Video guide for deploying Rails applications to Railway](https://www.youtube.com/watch?v=__1TadBZZUg)
...
- $20 a month is enough to host three applications
- Homepage link: [https://render.com/](https://render.com/)
...
- [Official getting started with Rails on Render guide](https://render.com/docs/deploy-rails)
- [GoRails video guide for deploying Rails applications to Render](https://www.youtube.com/watch?v=QJ4BcTQlKC0)
...
- $20 a month will be enough to host three applications.
- Homepage link: [https://www.heroku.com/](https://www.heroku.com/)
...
- [Official Rails guide for Heroku](https://devcenter.heroku.com/articles/getting-started-with-rails7)
- [GoRails video guide for deploying Rails applications to Heroku](https://www.youtube.com/watch?v=bQ2wXZf9irA)
...
If you don't recognize the error or what might cause it, your next step will be to copy and paste it into your favourite online search engine. You'll likely find a Stack Overflow post with a solution. You can get support in our Discord server if searching doesn't lead to anything conclusive.
...
The application logs are the output of your application as it's running. It tells you what's happening with your app as it's happening. All the incoming requests and database queries are logged, and you can see them logged in real-time.
